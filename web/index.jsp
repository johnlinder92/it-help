...
<!-- Navbar (sit on top) -->
    ...
    <div class="w3-bar w3-white w3-wide w3-padding w3-card">
        <a href="#" class="w3-bar-item w3-button w3-theme-l1"><b>JL</b> Webbutveckling </a>
        <!-- Float links to the right. Hide them on small screens -->
        <div class="w3-right w3-hide-small">
            <a href="#projects" class="w3-bar-item w3-button">Projekt</a>
            <a href="#about" class="w3-bar-item w3-button">Om mig</a>
            <a href="#contact" class="w3-bar-item w3-button">Kontakt</a>
        </div>
        <a href="application.jsp" class="w3-bar-item w3-button">Applikation</a>
    </div>
</div>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
    ...
    <div class="w3-display-middle w3-margin-top w3-center">
        <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>JL</b></span> <span class="w3-hide-small w3-text-light-grey">John Linder</span></h1>
    </div>
</header>
...
<div class="w3-content w3-padding" style="max-width:1564px">
    ...
    <div class="w3-container w3-padding-32" id="projects">
        <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Filmer</h3>
    </div>
    ...
    <div class="w3-container w3-padding-32" id="about">
        <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Om mig</h3>
